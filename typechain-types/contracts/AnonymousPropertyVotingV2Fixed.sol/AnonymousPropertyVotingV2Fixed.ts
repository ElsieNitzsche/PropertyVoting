...
export interface AnonymousPropertyVotingV2FixedInterface
  ...
  functions: {
    ...
    "forceCloseProposal(uint16,string)": FunctionFragment;
  ...
  events: {
    ...
    "ProposalForceClosed(uint16,string)": EventFragment;
...
export interface AnonymousPropertyVotingV2Fixed extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AnonymousPropertyVotingV2FixedInterface;
  ...
  filters: {
    ...
    "ProposalForceClosed(uint16,string)"(
      proposalId?: BigNumberish | null,
      reason?: null
