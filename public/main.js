...
async function loadProposals() {
    try {
        ...
        let votesFor = 0, votesAgainst = 0, isDecrypted = false, passed = false;
        try {
            [votesFor, votesAgainst, isDecrypted, passed] = await contract.getProposalResults(proposalId);
        } catch (e) {
            ...
            <div class="border border-gray-200 rounded-lg p-6">
                ...
                ${isActive ? `
                    <div class="mb-4">
                        ...
                        ${hasVoted ? `
                            <p class="text-green-600 text-sm font-medium">✓ You have voted</p>
                        ` : `
